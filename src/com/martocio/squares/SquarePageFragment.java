...
public class SquarePageFragment extends Fragment implements OnTouchListener,
	...
	private void addButtonListeners() {
		 final View btnSeeSolution = getView().findViewById(R.id.btn_see_solution);
	...
	public void onAnimationRepeat(Animation animation) {
	 ...
	 private void zoomImageFromThumb(final View thumbView) {
	        ...
	        String selectedImagePath=((MainActivity)getActivity()).getCurrentSelectedImage();
	        ...
	        getView().findViewById(R.id.top_btn_container).getGlobalVisibleRect(finalBounds, globalOffset);
	            ...
	            public void onClick(View view) {
	                ...
	                set.addListener(new AnimatorListenerAdapter() {
	                    ...
	                    public void onAnimationEnd(Animator animation) {
	                        ...
	                        getView().findViewById(R.id.centralpanel).setVisibility(View.VISIBLE);
	                        mCurrentAnimator = null;
	                    }
